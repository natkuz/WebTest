...
class OperationHelper(BasePage):
    ...
    def click_about_button(self):
        self.click_button(TestSearchLocators.ids["LOCATOR_ABOUT_BTN"], description="Click about button")
    ...
    def get_about_text(self):
        return self.get_text_from_element(TestSearchLocators.ids["LOCATOR_ABOUT_TEXT"])
    ...
    def get_attribute_element(self, locator, description=None):
        if description:
            element_name = description
        else:
            element_name = locator
        ...
        try:
            ...
            logging.exception(f"Exception while get text from {element_name}")
            return None
        logging.debug(f"We find text attribute {attr} in field {element_name}")
        return attr

    def get_size_font(self):
        return self.get_attribute_element(TestSearchLocators.ids["LOCATOR_ABOUT_TEXT"])['font-size']
